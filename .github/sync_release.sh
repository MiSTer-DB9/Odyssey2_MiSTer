...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Odyssey2_MiSTer.git"
CORE_NAME=(Odyssey2)
...
UPSTREAM_CORE_NAME=(Odyssey2)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Odyssey2.qsf)
COMPILATION_OUTPUT=(output_files/Odyssey2.rbf)
